Notice, the LEGO dataset has 16 classes. And since its dataset contains less images than cifar10 or minist, the number of users need to be small, or there will be an error.
